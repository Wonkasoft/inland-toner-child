...
<section class="toner">
  ...
  <div class="pdf-content">
    ...
    <p>You can download a copy <a href="<? echo get_stylesheet_directory_uri(); ?>/files/inlandpdf.pdf" download>here</a></p>
    <p>Have any questions? Email us at <a href="mailto: support@inlandtoner.com">support@inlandtoner.com</a></p>
  </div>

  <div class="pdf">
    <embed src="<? echo get_stylesheet_directory_uri(); ?>/files/inlandpdf.pdf" height="800" width="900"></embed>
  </div>
