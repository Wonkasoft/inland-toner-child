...
<? get_header(); ?>
    ...
    <div class="contentBx">
      <div class="about-section">
        ...
        <p>
          ...
          Dell, HP, Canon, Brother, and Lexmark. <a href="/about#certification">Learn more.</a>
        </p>
      </div>
      <div class="about-section">
        <h2>Our Mission</h2>
        <p>
          ...
          take your business, <a href="/quote" target="_blank">get a quote today!</a>
        </p>
      </div>
    </div>
    <img src="<? echo get_stylesheet_directory_uri(); ?>/IMAGES/Inventory/DSCF4109-Edit.jpg" />
  </section>
  ...
  <section class="certification">
    ...
    <div class="imgBx">
      <img src="<? echo get_stylesheet_directory_uri(); ?>/IMAGES/CERTIFICATION/stmc.jpg" />
      <img src="<? echo get_stylesheet_directory_uri(); ?>/IMAGES/CERTIFICATION/iso19798.png" />
      <img src="<? echo get_stylesheet_directory_uri(); ?>/IMAGES/CERTIFICATION/iso19752.png" />
    </div>
    <img src="<? echo get_stylesheet_directory_uri(); ?>/IMAGES/CERTIFICATION/iso9001.jpg" />
  ...
  <section class="manufacturers">
    ...
    <div class="imgBx">
      <img src="<? echo get_stylesheet_directory_uri(); ?>/IMAGES/MANUFACTURERS/dell.png" />
      <img src="<? echo get_stylesheet_directory_uri(); ?>/IMAGES/MANUFACTURERS/canon.png" />
      <img src="<? echo get_stylesheet_directory_uri(); ?>/IMAGES/MANUFACTURERS/hp.png" />
      <img src="<? echo get_stylesheet_directory_uri(); ?>/IMAGES/MANUFACTURERS/brother.png" />
      <img class="lexmark" src="<? echo get_stylesheet_directory_uri(); ?>/IMAGES/MANUFACTURERS/lexmark.png" />
    </div>
  </section>
